...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Announcement.announce_from'
        db.add_column(u'discussion_announcement', 'announce_from',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Announcement.announce_to'
        db.add_column(u'discussion_announcement', 'announce_to',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Announcement.announce_from'
        db.delete_column(u'discussion_announcement', 'announce_from')

        # Deleting field 'Announcement.announce_to'
        db.delete_column(u'discussion_announcement', 'announce_to')
